import SwiftUI
    ...
    @State private var iterationsInput = "500"
        ...
        @State private var result: InversePowerMethodEigenvalueResult?
                        ...
                        text: $iterationsInput
                            ...
                            if let result {
                                CalculationResultCard(
                                    items: [
                                        .init(
                                label: "Nearest Eigenvalue",
                                value: numberFormatter.format(result.nearestEigenvalue),
                                unit: "—"
                            ),
.init(
                                label: "Eigenvector X",
...
.init(
            ...
            .navigationTitle("Inverse Power Method")
        }
            ...
            do {
                result = try engine.calculate(
                    .init(
                        ...
                        shift: try InputValidator.parseNumber(
                            shiftInput,
                            fieldName: "shift"
                        ),
    ...
    #Preview {
        NavigationStack { InversePowerMethodEigenvalueView() }
    }
