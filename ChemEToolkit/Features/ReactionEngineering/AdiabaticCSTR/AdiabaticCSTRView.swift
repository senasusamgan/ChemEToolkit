...
struct AdiabaticCSTRView:
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: AppSpacing.xLarge) {
                ModuleHeaderView(
                    ...
                    subtitle:
                        "Size a perfectly mixed reactor at a target conversion and temperature",
                    tint: .orange
                )

                CalculatorInfoCard(tint: .orange) {
                    VStack(spacing: AppSpacing.small) {
                        Text("Adiabatic CSTR Design")
                            .font(.headline)
                        ...
                        Text(
                            "The outlet temperature is determined directly from conversion."
                        )
        ...
        .navigationTitle("Adiabatic CSTR")
    }
