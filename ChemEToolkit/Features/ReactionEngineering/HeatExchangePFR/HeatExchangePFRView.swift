...
struct HeatExchangePFRView: View {
    ...
    @State private var result: HeatExchangePFRResult?
    ...
    var body: some View {
            ...
            VStack(spacing: AppSpacing.xLarge) {
                ...
                CalculatorInfoCard(tint: .orange) {
                    VStack(spacing: AppSpacing.small) {
                        Text("dT/dX = ΔT_ad − h(T−T_c)/[k(T)(1−X)]")
                            .font(.headline)

                        Text("The coupled PFR balances are integrated over conversion with RK4.")
        ...
        .navigationTitle("Heat-Exchange PFR")
    }
