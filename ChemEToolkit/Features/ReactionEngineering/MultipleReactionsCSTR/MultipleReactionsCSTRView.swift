...
struct MultipleReactionsCSTRView:
    View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: AppSpacing.xLarge) {
                ModuleHeaderView(
                    ...
                    subtitle:
                        "Size a CSTR for consecutive first-order reactions A → B → C",
                    tint: .orange
                )

                CalculatorInfoCard(tint: .orange) {
                    VStack(spacing: AppSpacing.small) {
                        Text("Perfectly Mixed Consecutive Reactions")
                            .font(.headline)
                        ...
                        Text(
                            "The optimum CSTR residence time for the intermediate B is reported separately."
                        )
        ...
        .navigationTitle("Multiple Reactions CSTR")
    }
