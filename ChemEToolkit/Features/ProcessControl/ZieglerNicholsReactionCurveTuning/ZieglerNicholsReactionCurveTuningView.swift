...
struct ZieglerNicholsReactionCurveTuningView:
    View {
        ...
        ScrollView {
            VStack(spacing: AppSpacing.xLarge) {
                ModuleHeaderView(
                    ...
                    subtitle: "Tune P, PI and PID controllers from an FOPDT process model",
                    tint: .blue
                )

                CalculatorInfoCard(tint: .blue) {
                    Text("Reaction-curve tuning converts the fitted FOPDT gain, time constant and dead time into classic controller settings.")
...
.init(
        ...
        .navigationTitle("Ziegler–Nichols Reaction Curve")
    }
