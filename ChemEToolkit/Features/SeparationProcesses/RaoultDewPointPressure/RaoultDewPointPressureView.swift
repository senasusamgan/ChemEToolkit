...
struct RaoultDewPointPressureView:
    View {

    @State private var fractionInput = "0.60"
        ...
        ScrollView {
            VStack(spacing: AppSpacing.xLarge) {
                ModuleHeaderView(
                    ...
                    subtitle: "Calculate ideal binary dew pressure and first liquid",
                    tint: .purple
                )
                            ...
                            CalculationResultCard(
                                items: [
                                    .init(
                                        ...
                                        value: numberFormatter.format(result.dewPointPressure),
                                        unit: "kPa"
                                    ),
.init(
...
.init(
                                        label: "Liquid Mole Fraction 2",
                                        value: numberFormatter.format(result.liquidMoleFraction2),
                                        unit: "—"
                                    ),
.init(
        ...
        .navigationTitle("Raoult Dew-Point Pressure")
    }
